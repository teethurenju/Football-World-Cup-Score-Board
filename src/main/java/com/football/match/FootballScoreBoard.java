...
public class FootballScoreBoard {
     ...
     * If matchStatus = true, live match is going on
     * Else will call the start game method
     *
     ...
     * If matchStatus = false, no match is started
     * Else will call the finish game method
     * Add all the finished match details to a list
     *
     * @return
     */
     ...
     * If matchStatus = false, no match to update the score
	...
	public static void showMatchSummary(TeamDto teamDto) {
		...
		System.out.println(teamDto.getHomeTeam() + " " + teamDto.getHomeTeamScore()  + " - " +
				teamDto.getAwayTeam() + " " + teamDto.getAwayTeamScore()+"\n");
